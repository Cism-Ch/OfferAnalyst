...
This Express router provides complete REST API endpoints for todo management.

## Endpoints

### GET /api/todos
- **Purpose**: Retrieve all todos
- **Returns**: Array of Todo objects ordered by creation date (newest first)
...
### PATCH /api/todos/:id
- **Purpose**: Update todo completion status
- **Body**: `{ completed: boolean }`
- **Validation**: Completed must be boolean
- **Returns**: Updated Todo object
- **Response**: `ApiResponse<Todo>`

### DELETE /api/todos/:id
- **Purpose**: Delete todo by ID
- **Validation**: ID must be valid number
