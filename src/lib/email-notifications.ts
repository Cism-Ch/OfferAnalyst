...
export async function sendSecurityAlertEmail(
    ...
    try {
        ...
        const subject = `🔐 Security Alert: ${alertType.replace(/_/g, ' ')}`;
        const body = `
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div style="margin-top: 30px; padding: 15px; background: #fff3cd; border-left: 4px solid #ffc107; border-radius: 4px;">
                <strong>⚠️ If you did not authorize this activity:</strong><br>
                • Change your API keys immediately<br>
                • Review your account security<br>
                • Contact support
            </div>
        </div>
        <div class="footer">
...
export async function sendKeyRotationReminderEmail(
    ...
    try {
        const subject = '🔄 API Key Rotation Reminder';
        const body = `
...
OfferAnalyst Security Team
        ...
        if (process.env.NODE_ENV === 'development') {
            console.log('📧 [Key Rotation Reminder]');
            console.log('To:', userEmail);
            console.log('Subject:', subject);
            console.log('Body:', body);
        }
...
export async function sendKeyExpirationWarningEmail(
    ...
    try {
        const subject = '⏰ API Key Expiring Soon';
        const body = `
...
OfferAnalyst Team
        ...
        if (process.env.NODE_ENV === 'development') {
            console.log('📧 [Key Expiration Warning]');
            console.log('To:', userEmail);
            console.log('Subject:', subject);
            console.log('Body:', body);
        }
